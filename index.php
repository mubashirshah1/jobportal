...
<meta charset="utf-8">
<title>Online Job Portal - WebEng SWE-315</title>
...
<div class="container">
	<div class="sixteen columns">
		...
		<div id="logo" style="margin-top:15px">
			<h1><a href="index.php"><font style="font-size:25px; color:white">Job Portal - Find Your Dream JOB</font></a></h1>
		</div>
...
<div id="banner" class="with-transparent-header parallax background" style="background-image: url(images/banner-home-02.jpg)" data-img-width="2000" data-img-height="auto" data-diff="300">
	<div class="container">
		<div class="sixteen columns">
			...
			<div class="search-container">
				...
				<!-- Announce -->
				<div class="announce">
					It's Time to Find Your <strong>Dream</strong> Job!
				</div>
